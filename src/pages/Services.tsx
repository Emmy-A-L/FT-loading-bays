  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="flex flex-col justify-center border border-gray-500 p-8 items-center gap-2 w-9/10 md:w-1/2 lg:w-1/3 backdrop-blur-md rounded-xl text-center mx-4 md:mx-6 lg:mx-8 *:w-full *:border-b *:hover:border *:border-red-400 *:px-8 *:py-3 *:rounded-lg *:backdrop-blur-sm *:bg-gray-600/45">
        ...
        <Link to="/search-locations/midweek-service-locations">
          Midweek Service Locations
        </Link>
        <Link to="/search-locations/covenant-hour-of-prayer-locations">
          CHOP Locations
        </Link>
        <Link to="/search-locations/community-church-locations">
          Community Churches
        </Link>
        <Link to="/search-locations/brt-loading-bays">BRT Loading Bays</Link>
        <Link to="/search-locations/free-transportation-loading-bays">
          Free Transport Loading Bay
        </Link>
      </div>
    </div>
  );
